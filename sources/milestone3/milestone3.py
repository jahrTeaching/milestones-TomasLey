...
Richardson(Cauchy, Kepler, t1, U0, Euler_Inv, q_order = 1, iter = 2)

mpoints = [14,10,8]         # Número de puntos evaluados en el gráfico log(Error) - log(N)
temp_sch = [Euler, RK4, CN]
q_order = [1.,4.,2.]
...
for scheme in temp_sch:
    ...
    Richardson(Cauchy, Kepler, t2, U0, scheme, q_order[temp_sch.index(scheme)], iter)
